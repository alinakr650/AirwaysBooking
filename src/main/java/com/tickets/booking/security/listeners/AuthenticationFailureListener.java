...
import com.tickets.booking.domain.security.LoginFailure;
import com.tickets.booking.domain.security.User;
import com.tickets.booking.repository.security.LoginFailureRepository;
        ...
        if (event.getSource() instanceof UsernamePasswordAuthenticationToken) {
            ...
            if (token.getPrincipal() instanceof String) {
                ...
                userRepository.findByUsername((String) token.getPrincipal())
                        .ifPresentOrElse(builder::user, UserNotFoundException::new);
            }
